...
// 训练目标卡
renderGoalCard(null, {
  what: '<b>多臂老虎机问题 · 强化学习的简化特例</b>：<br/>⚠️ <b>注意：它不是完整的 RL</b>——这里只有"动作"和"奖励"，<b>没有状态转移</b>（你拉哪台不会改变环境）。它是用来引出"探索 vs 利用"这颗 RL 最小种子的。<br/>本页提供三种场景：<br/>① <b>标准 5 臂</b>（概率静态）② <b>10 臂更大池</b>（难度升级）③ <b>非平稳 5 臂</b>（真实概率会突然变化）',
  ...
  note: '非平稳场景下：你可以明显看到 Thompson 和 UCB 的弹性不同——这是真实世界推荐系统要面对的问题。下一章我们加回"状态"，得到完整 RL 框架：MDP。',
});
